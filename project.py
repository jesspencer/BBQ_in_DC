...
@app.route('/restaurants/<int:restaurant_id>mneu/<int:menu_id>/JSON')
...
def restaurantIndex():
    ...
    return render_template('menuIndex.html', restaurant= restaurant, items= items, restaurant_id= restaurant_id)
